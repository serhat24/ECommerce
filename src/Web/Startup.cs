    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddGoogle(options =>
            {
                ...
                //refactor
                options.ClientId = "212159698581-b1qkamg5povqmiupdelec81ldqlpqu7f.apps.googleusercontent.com"; //googleAuthNSection["ClientId"];
                options.ClientSecret = "6V0TAYCbh70233pIUUKXOPtV"; //googleAuthNSection["ClientSecret"];
            });
